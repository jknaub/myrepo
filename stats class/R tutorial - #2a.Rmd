...
mydata <- read.csv("/tmp/myrepo/stats class/tutorial_2-jknaub-main/tutorial_2-jknaub-main/mammals.csv", stringsAsFactors = FALSE) #add the file path for your data in place of "directory_name" if you have a mac add a ~ to the front end "~//mammal.csv"
...
```{r}
# using readr package
mydata <- read.csv("/tmp/myrepo/stats class/tutorial_2-jknaub-main/tutorial_2-jknaub-main/mammals.csv")
```
...
```{r}
# base R method:
mydata <- read.csv("/tmp/myrepo/stats class/tutorial_2-jknaub-main/tutorial_2-jknaub-main/mammals.csv", stringsAsFactors = FALSE,
                  strip.white = TRUE, na.strings = c("NA", "") )
# using readr package
mydata <- read.csv("/tmp/myrepo/stats class/tutorial_2-jknaub-main/tutorial_2-jknaub-main/mammals.csv", na = c("NA", ""))
```
...
# using readr package
mydata <- read_csv("/directoryname/mammal.csv", na = c(""))

levels(factor(mydata$continent)) # Note "NA" is now back for North America
```
...
```{r}
# base R
write.csv(mydata, file="/tmp/myrepo/stats class/tutorial_2-jknaub-main/tutorial_2-jknaub-main/doesthiswork.csv")
